...
const App = ({ setActiveLink }) => {
  ...
  return (
    <div className="app">
      <form>
        <h1>Document</h1>
        <h2 className="h2" style={{ width: '710px' }}>
          a
        </h2>
        <h3>70% complete</h3>
        <div className="col">
          <div className="formpage">
            <p className="page">
              "Do you have any business documents? Don’t worry if not, as we’ll
              send you advice on how to make them once you’ve submitted your
              pitch. If you do have some, make sure you upload them as they will
              make your pitch look super professional."
            </p>
            <p className="page">
              <b>Please note: </b>If an investor downloads one of your
              documents, you will then be able to message them directly. So make
              sure you upload at least one document!
            </p>
            ...
            <button type="submit">
              <a href="/InvestorFirstPage" style={{ color: 'white' }}>
                Submit
              </a>
            </button>
          </div>
