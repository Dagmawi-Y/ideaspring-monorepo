...
const App = ({ setActiveLink }) => {
  ...
  const renderInputElements = () => {
    if (selectedSource === 'youtube') {
      ...
      return (
        <input type="file" className="input" style={{ outline: 'none' }} />
      );
    }
  };
  ...
  return (
    <div className="app">
      <form>
        ...
        <h2 className="h2" style={{ width: '690px' }}>
          a
        </h2>
        <h3>60% complete</h3>
        <div className="col">
          <div className="formpage">
            <p className="page">
              "Nearly there! Images and videos are often the difference for the
              most successful pitches on our site. Investors, like everyone,
              respond really well to visuals. So give your pitch the best chance
              to stand out and drop in some relevant images."
            </p>
            ...
            <div className="containern">
              ...
              <p style={{ marginBottom: '10px' }}>
                ID Examples: YouTube = EKyirtVHsK0 and Vimeo = 76357912
              </p>
