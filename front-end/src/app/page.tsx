    ...
    <body>
      ...
      <header className="section__container header__container">
        <div className="header__content">
          ...
          <h1>
            <span>Where</span> Ideas Find Wings
          </h1>
          <p>
            <strong>CoGrow</strong> is Entrepreneurs and Angel Investors
            Networking Platform that seamlessly connects Entrepreneurs with
            angel investors, and innovative financing service through motivated
            team and the art of technology.
          </p>
          <div>
            ...
            {showDropdownButtons && (
              <div className="dropdown-container">
                <a
                  href="/startup/Registration?role=entrepreneur"
                  className="dropdown-button"
                >
                  As Entrepreneur
                </a>
                <a
                  href="/Registration?role=investor"
                  className="dropdown-button"
                >
                  As Investor
                </a>
                <a
                  href="/Registration?role=engager"
                  className="dropdown-button"
                >
                  As Engager
                </a>
