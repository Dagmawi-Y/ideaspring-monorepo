...
import "./style.css"
import { FaArrowLeft,FaExchangeAlt, FaArrowRight, FaUsers, FaBullhorn, FaHandshake, FaShoppingBasket, FaStar, FaVideo, FaBuilding, FaCheckCircle, FaQuoteRight, FaFacebook, FaInstagram, FaTwitter } from 'react-icons/fa';
import { RiStarFill, RiUserStarFill, RiMessage2Line } from 'react-icons/ri';
import { RiStarHalfFill,RiBuildingLine, RiCheckboxCircleLine, RiArrowLeftLine, RiArrowRightLine } from 'react-icons/ri';
  ...
  <body>
    <nav>
      <div className="nav__logo">
        <a href="#"><img src="/cogrow.png" alt="logo" /></a>
      </div>
    ...
    <section className="section__container explore__container">
      ...
      <div className="explore__grid">
        ...
        <span><FaExchangeAlt /></span>
          ...
          <p>
          Utilizes a sophisticated matching algorithm that analyzes the profiles of startups and angel investors to identify compatible matches.
          </p>
          <a href="/Startup/Sreg">Join Now <FaArrowRight /></a>
        </div>
        <div className="explore__card">
        ...
        <span><FaHandshake /></span>
          ...
          <p>
          Curates and promotes events and networking opportunities specifically tailored for Entrepreneurs and angel investors. 
          </p>
          <a href="#">Join Now <FaArrowRight /></a>
        </div>
        <div className="explore__card">
        <span><FaUsers /></span>
          ...
          <p>
          Provides a dedicated online community forum or discussion platform where Entrepreneurs, angel investors, and industry professionals can engage in discussions, seek advice, and share insights
          </p>
          <a href="#">Join Now <FaArrowRight /></a>
        </div>
      </div>
    ...
    <section className="section__container class__container">
      ...
      <div className="class__content">
        ...
        <p>
        The premier destination for startups and investors to connect, collaborate, and drive innovation. 
        Our platform offers a unique opportunity 
        to bridge the gap between visionary entrepreneurs and forward-thinking investors.
        Our rigorous screening process ensures that only the most innovative and high-potential ventures make it to our platform.
        </p>
        <button className="btn">JOIN NOW</button>
      </div>
    </section>
        ...
        <div className="join__grid">
          ...
          <span><RiStarFill /></span>
            <div className="join__card__content">
              ...
              <p>comprehensive profile management services for entrepreneur and investors</p>
            </div>
          </div>
          <div className="join__card">
          <span><RiUserStarFill /></span>
            <div className="join__card__content">
              ...
              <p>Allows engagers to provide feedback and ratings based on their experiences. </p>
            </div>
          </div>
          <div className="join__card">
          <span><RiMessage2Line /></span>
            <div className="join__card__content">
              ...
              <p>Facilitates seamless communication between entrepreneur and investors</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="section__container price__container">
      ...
      <p className="section__subheader">
      Entrepreneurs from diverse industries and growth stages make up our dynamic startup community.
      Angle invesrtors and Engagers.
      </p>
    ...
    <section className="review">
      <div className="section__container review__container">
        ...
        <div className="review__content">
          <h4>MEMBER REVIEW</h4>
          <p>
          What truly sets LinkUp Connect apart is our exceptional team of expert advisors. 
          Our advisors are seasoned professionals with extensive experience in the startup 
          and investment landscape. They are knowledgeable, 
          approachable, and genuinely invested in helping entrepreneurs and investors achieve their goals.
          </p>
    ...
    <footer className="section__container footer__container">
      ...
      <div className="footer__col">
        <div className="footer__logo"><img src="/cogrow.png" alt="logo" /></div>
        <p>
        Take the first step towards an exciting journey of entrepreneurial success with our unbeatable partnership plans. 
        Let's collaborate, innovate, and conquer the business world together!
        </p>
